...
const CAMPAIGN_SPECS: readonly CampaignSpec[] = [
  ...
  { id: "campaign-easy-2", difficulty: "Easy", rule: { family: "combine", axis: "rows", operation: "join", transform: "none" }, sources: [[6, "square", "outline", 1, 0, 0], [1, "square", "outline", 1, 0, 0], [10, "square", "solid", 1, 0, 0], [7, "square", "solid", 1, 0, 0], [8, "circle", "outline", 1, 0, 0], [4, "circle", "outline", 1, 0, 0]], correctIndex: 1 },
  ...
  { id: "campaign-easy-10", difficulty: "Easy", rule: { family: "combine", axis: "rows", operation: "left-minus-right", transform: "none" }, sources: [[14, "circle", "solid", 1, 0, 0], [6, "circle", "solid", 1, 0, 0], [10, "circle", "solid", 1, 0, 0], [3, "circle", "solid", 1, 0, 0], [13, "circle", "solid", 1, 0, 0], [3, "circle", "solid", 1, 0, 0]], correctIndex: 0 },
  ...
  { id: "campaign-easy-12", difficulty: "Easy", rule: { family: "combine", axis: "rows", operation: "left-minus-right", transform: "none" }, sources: [[6, "square", "solid", 1, 0, 0], [3, "square", "solid", 1, 0, 0], [3, "square", "outline", 1, 0, 0], [14, "square", "outline", 1, 0, 0], [5, "square", "solid", 1, 0, 0], [6, "square", "solid", 1, 0, 0]], correctIndex: 1 },
  { id: "campaign-medium-1", difficulty: "Medium", rule: { family: "combine", axis: "rows", operation: "right-minus-left", transform: "none" }, sources: [[9, "circle", "outline", 1, 0, 0], [3, "circle", "outline", 1, 0, 0], [4, "circle", "striped", 1, 0, 0], [6, "circle", "striped", 1, 0, 0], [13, "square", "outline", 1, 0, 0], [3, "square", "outline", 1, 0, 0]], correctIndex: 2 },
  { id: "campaign-medium-2", difficulty: "Medium", rule: { family: "combine", axis: "rows", operation: "right-minus-left", transform: "none" }, sources: [[10, "triangle", "striped", 1, 1, 3], [14, "triangle", "striped", 1, 1, 3], [13, "triangle", "solid", 1, 1, 0], [11, "triangle", "solid", 1, 1, 0], [7, "triangle", "solid", 1, 1, 0], [11, "triangle", "solid", 1, 1, 0]], correctIndex: 0 },
  { id: "campaign-medium-3", difficulty: "Medium", rule: { family: "combine", axis: "rows", operation: "right-minus-left", transform: "none" }, sources: [[8, "circle", "outline", 1, 0, 0], [13, "circle", "outline", 1, 0, 0], [13, "triangle", "solid", 1, 2, 0], [11, "triangle", "solid", 1, 2, 0], [7, "square", "outline", 1, 0, 0], [11, "square", "outline", 1, 0, 0]], correctIndex: 3 },
  { id: "campaign-medium-4", difficulty: "Medium", rule: { family: "sequence", axis: "rows", step: "rotate-clockwise" }, sources: [[15, "triangle", "solid", 1, 3, 0], [9, "square", "striped", 1, 0, 1], [8, "triangle", "outline", 1, 2, 0]], correctIndex: 1 },
  { id: "campaign-medium-5", difficulty: "Medium", rule: { family: "sequence", axis: "rows", step: "rotate-clockwise" }, sources: [[3, "square", "striped", 1, 0, 2], [12, "circle", "outline", 1, 0, 0], [3, "circle", "striped", 1, 0, 1]], correctIndex: 0 },
  { id: "campaign-medium-6", difficulty: "Medium", rule: { family: "sequence", axis: "rows", step: "rotate-clockwise" }, sources: [[8, "triangle", "solid", 1, 2, 0], [9, "triangle", "solid", 1, 0, 0], [6, "circle", "striped", 1, 0, 0]], correctIndex: 2 },
  ...
  { id: "campaign-medium-10", difficulty: "Medium", rule: { family: "combine", axis: "columns", operation: "join", transform: "none" }, sources: [[12, "circle", "solid", 1, 0, 0], [5, "circle", "solid", 1, 0, 0], [8, "circle", "striped", 1, 0, 2], [1, "circle", "striped", 1, 0, 2], [2, "square", "solid", 1, 0, 0], [8, "square", "solid", 1, 0, 0]], correctIndex: 1 },
  { id: "campaign-medium-11", difficulty: "Medium", rule: { family: "combine", axis: "columns", operation: "overlap", transform: "none" }, sources: [[11, "circle", "outline", 1, 0, 0], [14, "circle", "outline", 1, 0, 0], [10, "circle", "solid", 1, 0, 0], [12, "circle", "solid", 1, 0, 0], [7, "bar", "striped", 1, 0, 2], [9, "bar", "striped", 1, 0, 2]], correctIndex: 3 },
  { id: "campaign-medium-12", difficulty: "Medium", rule: { family: "combine", axis: "columns", operation: "cancel", transform: "none" }, sources: [[1, "triangle", "striped", 1, 0, 3], [15, "triangle", "striped", 1, 0, 3], [10, "square", "striped", 1, 0, 0], [6, "square", "striped", 1, 0, 0], [14, "bar", "striped", 1, 1, 3], [7, "bar", "striped", 1, 1, 3]], correctIndex: 0 },
  { id: "campaign-hard-1", difficulty: "Hard", rule: { family: "combine", axis: "rows", operation: "match", transform: "none" }, sources: [[3, "triangle", "outline", 1, 2, 0], [14, "triangle", "outline", 1, 2, 0], [1, "square", "striped", 0, 0, 2], [8, "square", "striped", 0, 0, 2], [14, "triangle", "outline", 0, 3, 0], [2, "triangle", "outline", 0, 3, 0]], correctIndex: 1 },
  ...
  { id: "campaign-hard-4", difficulty: "Hard", rule: { family: "combine", axis: "columns", operation: "neither", transform: "none" }, sources: [[2, "circle", "solid", 1, 0, 0], [12, "circle", "solid", 1, 0, 0], [10, "square", "solid", 1, 0, 0], [3, "square", "solid", 1, 0, 0], [8, "circle", "outline", 0, 0, 0], [6, "circle", "outline", 0, 0, 0]], correctIndex: 2 },
  ...
  { id: "campaign-hard-9", difficulty: "Hard", rule: { family: "combine", axis: "rows", operation: "right-minus-left", transform: "rotate-half" }, sources: [[9, "square", "outline", 2, 0, 0], [4, "square", "outline", 2, 0, 0], [2, "triangle", "solid", 0, 1, 0], [15, "triangle", "solid", 0, 1, 0], [13, "circle", "solid", 2, 0, 0], [11, "circle", "solid", 2, 0, 0]], correctIndex: 1 },
  ...
  { id: "campaign-wizard-4", difficulty: "Wizard", rule: { family: "combine", axis: "columns", operation: "join", transform: "rotate-clockwise" }, sources: [[15, "bar", "outline", 2, 1, 0], [9, "bar", "outline", 2, 1, 0], [3, "circle", "solid", 2, 0, 0], [4, "circle", "solid", 2, 0, 0], [14, "triangle", "striped", 1, 2, 0], [5, "triangle", "striped", 1, 2, 0]], correctIndex: 0 },
  ...
  { id: "campaign-wizard-9", difficulty: "Wizard", rule: { family: "combine", axis: "columns", operation: "overlap", transform: "rotate-counterclockwise" }, sources: [[9, "bar", "striped", 0, 0, 0], [9, "bar", "striped", 0, 0, 0], [5, "bar", "solid", 1, 0, 0], [3, "bar", "solid", 1, 0, 0], [14, "triangle", "outline", 0, 0, 0], [7, "triangle", "outline", 0, 0, 0]], correctIndex: 0 },
  ...
  { id: "campaign-wizard-12", difficulty: "Wizard", rule: { family: "combine", axis: "columns", operation: "left-minus-right", transform: "rotate-half" }, sources: [[6, "bar", "solid", 1, 0, 0], [5, "bar", "solid", 1, 0, 0], [3, "circle", "striped", 2, 0, 0], [1, "circle", "striped", 2, 0, 0], [13, "square", "outline", 0, 0, 0], [11, "square", "outline", 0, 0, 0]], correctIndex: 2 },
];
