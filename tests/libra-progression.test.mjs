...
} from "../app/games/libra/infinite-progression.ts";
...
test("Libra Infinite starts at Starter and promotes through all four levels", () => {
...
test("Libra Infinite demotes on two misses in three and ignores retries", () => {
  let state = {
    ...initialInfiniteAdaptiveState(),
...
test("Libra energy is linear and capped at combo eight", () => {
